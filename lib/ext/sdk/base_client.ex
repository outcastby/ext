defmodule Ext.Sdk.BaseClient do
  defmacro __using__(endpoints: endpoints) do
    quote bind_quoted: [endpoints: endpoints] do
      ...
      """
      @spec method_missing(method_name :: Atom, List.new(%Ext.Sdk.Request{})) :: %{}
      def method_missing(method_name, %Ext.Sdk.Request{headers: headers, payload: payload, options: options}) do
